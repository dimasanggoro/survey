	...
	<body>
		...
		<div class="padding-15">
			...
			<div class="login-box">
				...
				<!-- login form -->
				<form action="sr_void.php" method="post" class="sky-form boxed">
					...
					<fieldset>	
						...
						<section>
							...
							<label class="input">
								...
								<span class="tooltip tooltip-top-right">User Computer</span>
							</label>
						</section>
						...
						<section>
							...
							<label class="input">
								...
								<b class="tooltip tooltip-top-right">Ketik Password</b>
							</label>
